...
pub fn build(b: *std.Build) void {
    ...
    const files = [_][]const u8{
        ...
        "Cryptographic Hash Functions/JH.zig",
        "Cryptographic Hash Functions/Blake2s.zig",
        "Symmetric Key Cryptography/AES.zig",
        "Symmetric Key Cryptography/ChaCha20.zig",
        "Symmetric Key Cryptography/ChaCha20Poly1305.zig",
        "Symmetric Key Cryptography/TripleDES.zig",
        "Symmetric Key Cryptography/Blowfish.zig",
        "Symmetric Key Cryptography/Poly1305.zig",
        ...
        "Password Hashing & Key Derivation/HKDF.zig",
        ...
        "Asymmetric Cryptography & Key Exchange/BLS.zig",
        "Asymmetric Cryptography & Key Exchange/Schnorr.zig",
